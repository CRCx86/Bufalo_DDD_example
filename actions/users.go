...
func NewUserResource(service *service.UsersService) *UsersResource {
...
func (v UsersResource) List(c buffalo.Context) error {
	...
	users, q, err := v.usersService.List(c)
	if err != nil {
		return err
	}
...
func (v UsersResource) Show(c buffalo.Context) error {
	...
	user, err := v.usersService.Show(c)
...
func (v UsersResource) Create(c buffalo.Context) error {
	...
	verrs, user, err := v.usersService.Create(c)
	if err != nil {
		return err
	}
...
func (v UsersResource) Edit(c buffalo.Context) error {
	...
	user, err := v.usersService.Edit(c)
	if err != nil {
		return err
	}
...
func (v UsersResource) Update(c buffalo.Context) error {
	...
	verrs, user, err := v.usersService.Update(c)
	if err != nil {
		return err
	}
...
func (v UsersResource) Destroy(c buffalo.Context) error {
	...
	user, err := v.usersService.Destroy(c)
	if err != nil {
		return err
	}
